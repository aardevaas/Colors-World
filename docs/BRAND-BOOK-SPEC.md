...
This one produces a document where the rules are measured — and it should be
possible to leave after ten minutes with a two-page colour spec and never know
the other fifty-two components existed.**
